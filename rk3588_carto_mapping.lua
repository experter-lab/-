-- RK3588 + RPLIDAR S1 + Cartographer 2D lidar-only mapping.
-- Standard Cartographer SLAM flow adapted only for this robot's frames,
-- lidar range, and 3 cm map resolution. No wheel odometry and no IMU.
